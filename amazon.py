...
while True:
    ...
    if(curr_price <= your_price): 
        msg = client.messages.create(to="+917404663867", from_="+14843094282", body="rush to Amazon, Price of Headsets are below your price") #Will send SMS to your phone number
